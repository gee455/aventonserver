...
class StripeModule {
    ...
    private function updateCustomerDefCard($args) {
        ...
        $customer->default_source = $args['card_id'];
    ...
    private function getCardData($args) {
        ...
        $card = $customer->sources->retrieve($args["card_id"]);
    ...
    private function updateCard($args) {
        ...
        $card = $cu->sources->retrieve($args["card_id"]);
...
//        $card->name = $args["name"];
    ...
    private function getAllCards($args) {
        ...
        $cards = Stripe_Customer::retrieve($args['stripe_id']); //->sources->all();
    ...
    private function deleteCard($args) {
        ...
        $card = $cu->sources->retrieve($args["card_id"])->delete();
