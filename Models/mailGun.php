...
<br><br>
  ...
  <div style="color: black;font-size:12px;">
    ...
    public function sendInvoice($masData, $pasData, $apptData) {
        ...
        return $this->mailFun($recipients, $subject, $invoice['html']);
    }
...
<div>The " . $this->appName . " Team.</div>";
    ...
    public function acceptRejectUser($details) {
     ...
     public function mailFun($recipients, $subject, $body) {
...
$mgClient = new Mailgun('key-c9da57b28ae7fc33db9deccac0050e31');
$domain = "sandboxa0deee192fa1426cbf31b2b350676db4.mailgun.org";

# Make the call to the client.
$result = $mgClient->sendMessage("$domain",
                  array('from'    =>'roadyo1.0@gmail.com',//'Mailgun Sandbox <postmaster@sandboxa0deee192fa1426cbf31b2b350676db4.mailgun.org>',
                        'to'      => 'mahadev@mobifyi.com',
                        'subject' => $subject,
                        'text'    => $body));   
            $result['flag'] = 0;          
            return $result;
