...
//        $("#datepicker1").datepicker({ minDate: 0});
 ...
 $("#file_upload").change(function ()
        ...
        $('#city_select').change(function () {
            $('#getvechiletype').load('<?php echo base_url() ?>index.php/companyadmin/ajax_call_to_get_types/vtype', {city: $('#city_select').val()});
        });


        $('#title').change(function () {
            $('#vehiclemodel').load('<?php echo base_url() ?>index.php/companyadmin/ajax_call_to_get_types/vmodel', {adv: $('#title').val()});
        });
    });
...
//        }
    ...
    function cancel(){
            ...
            window.location="<?php echo base_url(); ?>//index.php/companyadmin/Drivers/my/1";
    }
        ...
        <div class="jumbotron bg-white" data-pages="parallax">
            <div class="inner">
                ...
                <ul class="breadcrumb" style="margin-left: 20px;">
                    <li><a href="<?php echo base_url(); ?>//index.php/companyadmin/Drivers/my/1" class=""><?php echo LIST_DRIVER; ?></a>
                    </li>
            ...
            <div class="container-fluid container-fixed-lg bg-white">
                ...
                <div id="rootwizard" class="m-t-50">
                    ...
                    <!-- Tab panes -->
                    <form id="addentity" class="form-horizontal" role="form" action="<?php echo base_url(); ?>index.php/companyadmin/editdriverdata" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row row-same-height">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text"  id="firstname" name="firstname" required="required"class="form-control"  disabled="disabled"value="<?php echo $row->first_name;?>"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" id="lastname" name="lastname" required="required"class="form-control" value="<?php echo $row->last_name;?>" disabled="disabled">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="file" class="form-control" style="height: 37px;" name="photos" id="file_upload" disabled="disabled" >
                                ...
                                <div class="row row-same-height">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="password"  id="password" name="password" required="required" class="form-control" value="<?php echo $row->password;?>" disabled="disabled" >
                            ...
                            <div class="tab-pane slide-left padding-20" id="tab3">
                                <div class="row row-same-height">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="file" class="form-control" style="height: 37px;" name="certificate" id="file_upload_l" disabled="disabled">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input id="expirationrc" name="expirationrc" required="required"  type="" class="form-control datepicker-component" disabled="disabled"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="file" class="form-control" style="height: 37px;" name="passbook"  id="file_upload_p" disabled="disabled">
