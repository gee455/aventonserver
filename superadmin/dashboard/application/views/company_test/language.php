...
define("POPUP_DRIVER_DRIVER_PASSWORD_VALID", "The password  length must be 6 and at least one number followed by character only (no special characters)");
...
define("POPUP_ACCEPTED", "Are you sure do you want to activate this company and have validated all Of Its Documents ,etc. ? ");
define("POPUP_REJECTED", "Are you sure do you want to reject this company and have validated all of its documents ,etc ? ");
...
define("POPUP_COMPANY_DELETE_DELETE_COUNTRY", "your selected country deleted successfully");
...
define("POPUP_VEHICLETYPE_NOSEATINGS", "Please enter the number of seating’s");
...
define("POPUP_VEHICLETYPE_KM", "Enter the cost per kilometre");
...
define("POPUP_PASSENGERS_PASSVALID", "Password  length must be 6 and at least one number followed by character only(no special characters)");
