...
<!--                <div class="sidebar-header-controls " class="pull-left" style="margin-left:-60px" >
            ...
            <div class="sidebar-menu">
                <ul class="menu-items">
                      ...
                      <li class="dashboard">
                        <a href="<?php echo base_url(); ?>index.php/companyadmin/Dashboard">
                            <span class="title"><?php echo NAV_DASHBOARD; ?></span>
                        </a>
                        <span class="icon-thumbnail <?php echo (base_url() . "index.php/companyadmin/Dashboard" == $request_uri ? "bg-success" : ""); ?> dashboard_thumb" >
                     ...
                     <li class="Vehicles">
                        <a href="<?php echo base_url(); ?>index.php/companyadmin/Vehicles/5">
                    ...
                    <li class="Drivers">
                        <a href="<?php echo base_url(); ?>index.php/companyadmin/Drivers/my/1">
                    ...
                    <li class="payroll">
                        <a href="<?php echo base_url(); ?>index.php/companyadmin/payroll">
                    ...
                    <li class="transection">
                        <a href="<?php echo base_url(); ?>index.php/companyadmin/transection">
