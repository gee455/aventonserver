...
//            },
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": '<?php echo base_url() ?>index.php/companyadmin/payroll_data_form_date/' + st + '/' + end + '/' + $('#companyid').val(),
                "bJQueryUI": true,
    ...
    function refreshTableOnCityChange() {
        ...
        if ($('#start').val() != '' || $('#end').val() != '') {
            ...
            url = '<?php echo base_url() ?>index.php/companyadmin/payroll_data_form_date/' + st + '/' + end + '/' + $('#companyid').val();

        } else {
            url = '<?php echo base_url(); ?>index.php/companyadmin/payroll_ajax';
        }
        var settings = {
            "autoWidth": false,
            "sDom": "<'table-responsive't><'row'<p i>>",
...
//            },
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url(); ?>index.php/companyadmin/payroll_ajax',
            "bJQueryUI": true,
            "sPaginationType": "full_numbers",
            "iDisplayStart ": 20,
            "oLanguage": {
