            ...
            function VerifyNsendLink()
            {
              var  resetemail = $("#txtforgotpassword").val();
                ...
                else
                {
                    ...
                    $.ajax({
                        url: '<?php echo base_url() ?>index.php/companyadmin/ForgotPassword',
                        type: 'POST',
        ...
        <div class="login-wrapper ">
                ...
                <img src="<?php echo base_url() ?>theme/assets/img/demo/new-york-city-buildings-sunrise-morning-hd-wallpaper.jpg" data-src="<?php echo base_url() ?>theme/assets/img/demo/new-york-city-buildings-sunrise-morning-hd-wallpaper.jpg" data-src-retina="<?php echo base_url() ?>theme/assets/img/demo/new-york-city-buildings-sunrise-morning-hd-wallpaper.jpg" alt="" class="lazy">
                 ...
                 <div class="bg-caption pull-bottom sm-pull-bottom text-white p-l-20 m-b-20">
                    <h2 class="semi-bold text-white">
                         Whey go with Uber when your business can get <?php echo Appname;?> ! Get your taxi business on mobile !</h2>
                    <p class="small">
                        images Displayed are solely for representation purposes only, All work copyright of respective owner, otherwise © <?php echo copyright;?>.<br>                        
            ...
            <div class="login-container bg-white">
                <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
                    ...
                    <form id="form-login" class="p-t-15" role="form" action ="<?php echo base_url() ?>index.php/companyadmin/AuthenticateUser" onsubmit= "return validateForm();" method="post">
...
<!--                         START Form Control
                    ...
                    <!--END Login Form-->
<!--                    this code is for latter use if u want add image in bottom then edit here
