...
//            },
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": '<?php echo base_url() ?>index.php/companyadmin/transection_data_form_date/' + st + '/' + end + '/' + $('#search_by_select').val() + '/' + $('#companyid').val(),
                "bJQueryUI": true,
...
//            },
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": '<?php echo base_url() ?>index.php/companyadmin/search_by_select/' + $('#search_by_select').val(),
                "bJQueryUI": true,
                "sPaginationType": "full_numbers",
                "iDisplayStart ": 20,
                "oLanguage": {
...
//            $("#callone").trigger("click");
    ...
    function refreshTableOnCityChange() {
        ...
        if ($('#start').val() != '' || $('#end').val() != '') {
            ...
            url = '<?php echo base_url() ?>index.php/companyadmin/transection_data_form_date/' + st + '/' + end + '/' + $('#search_by_select').val() + '/' + $('#companyid').val();

        } else {
            url = '<?php echo base_url() ?>index.php/companyadmin/search_by_select/' + $('#search_by_select').val();
        }
        var settings = {
            "autoWidth": false,
            "sDom": "<'table-responsive't><'row'<p i>>",
...
//            },
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url(); ?>index.php/companyadmin/transection_data_ajax',
            "bJQueryUI": true,
            "sPaginationType": "full_numbers",
            "iDisplayStart ": 20,
            "oLanguage": {
