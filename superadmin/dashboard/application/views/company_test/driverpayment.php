...
<!--                <p>We need payment information inorder to process your order</p>-->
            ...
            <div class="modal-body">
                <form id="form-work" class="form-horizontal" role="form" autocomplete="off" novalidate="novalidate" action="<?php echo base_url() ?>index.php/companyadmin/pay_driver_amount/<?php echo $mas_id ?>" method="post">
