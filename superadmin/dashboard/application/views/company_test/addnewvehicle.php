        ...
        <div class="jumbotron bg-white" data-pages="parallax">
            <div class="inner">
                ...
                <ul class="breadcrumb" style="margin-left: 20px;">
                    <li><a href="<?php echo base_url('index.php/companyadmin') ?>/Vehicles/5" class=""><?php echo LIST_VEHICLE; ?></a>
                    </li>
            ...
            <div class="container-fluid container-fixed-lg bg-white">
                ...
                <div id="rootwizard" class="m-t-50">
                    ...
                    <!-- Tab panes -->
                    <form id="addentity" class="form-horizontal" role="form" action="<?php echo base_url(); ?>index.php/companyadmin/AddNewVehicleData" method="post" enctype="multipart/form-data">
