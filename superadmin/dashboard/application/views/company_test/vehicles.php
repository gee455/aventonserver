...
//     
            ...
            if (val.length > 0) {
                ...
                $("#confirmed").click(function () {
                    ...
                    $.ajax({
                        url: "<?php echo base_url('index.php/companyadmin') ?>/reject_vehicle",
                        type: "POST",
                        data: {val: val},
                        dataType: 'json',
                        success: function (result)
        ...
        $("#edit").click(function () {
            ...
            {
                window.location = "<?php echo base_url() ?>index.php/companyadmin/editvehicle/" + val;
        ...
        $("#active").click(function () {
            ...
            if (val.length > 0)
            {
                ...
                $("#confirmeds").click(function () {
                    {
                        $.ajax({
                            url: "<?php echo base_url('index.php/companyadmin') ?>/activate_vehicle",
                            type: "POST",
                            data: {val: val},
                            dataType: 'json',
                            success: function (result)
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var settings = {
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url() ?>index.php/companyadmin/datatable_vehicles/' + status,
            "bJQueryUI": true,
            "sPaginationType": "full_numbers",
            "iDisplayStart ": 20,
            "oLanguage": {
...
//            $("#confirmeds").click(function () {
            ...
            $.ajax({
                url: "<?php echo base_url('index.php/companyadmin') ?>/documentgetdatavehicles",
                type: "POST",
                data: {val: val},
                dataType: 'json',
                success: function (result)
...
//                        document.getElementById("doc_body").deleteRow();
//            });
                ...
                <div class="panel panel-transparent ">
                    ...
                    <ul class="nav nav-tabs nav-tabs-fillup  bg-white whenclicked">
                        <li  id= "5" class="tabs_active <?php echo ($status == 5 ? "active" : ""); ?> " style="cursor:pointer">
                            <a  class="changeMode" data="<?php echo base_url(); ?>index.php/companyadmin/datatable_vehicles/5"><span><?php echo LIST_NEW; ?></span></a>
                        </li>
                        <li id= "2"  class="tabs_active <?php echo ($status == 2 ? "active" : ""); ?> " style="cursor:pointer">
                            <a class="changeMode" data="<?php echo base_url(); ?>index.php/companyadmin/datatable_vehicles/12"><span><?php echo LIST_ACCEPTED; ?></span></a>
                        </li>
                        <li id= "4" class="tabs_active <?php echo ($status == 4 ? "active" : ""); ?> " style="cursor:pointer">
                            <a class="changeMode" data="<?php echo base_url(); ?>index.php/companyadmin/datatable_vehicles/4"><span><?php echo LIST_REJECTED; ?></span></a>



                        </li>
                        <li id= "1" class="tabs_active <?php echo ($status == 1 ? "active" : ""); ?> " style="cursor:pointer">
                            <a class="changeMode"  data="<?php echo base_url(); ?>index.php/companyadmin/datatable_vehicles/2"><span><?php echo LIST_FREE; ?></span></a>
                        </li>
                        <div class="dltbtn">
...
<!--                        <div class="pull-right m-t-10"> <button class="btn btn-primary btn-cons" id="reject"><?php echo BUTTON_REJECT; ?></button></div>
                        ...
                        <div class="pull-right m-t-10"><a href="<?php echo base_url() ?>index.php/companyadmin/addnewvehicle/"> <button class="btn btn-primary btn-cons" id="add"><?php echo BUTTON_ADD; ?></button></a></div>
                    </ul>
                    <!-- Tab panes -->
