...
//            },
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": '<?php echo base_url() ?>index.php/masteradmin/payroll_data_form_date/' + st + '/' + end + '/' + $('#companyid').val(),
                "bJQueryUI": true,
    ...
    function refreshTableOnCityChange() {
        ...
        if ($('#start').val() != '' || $('#end').val() != '') {
            ...
            url = '<?php echo base_url() ?>index.php/masteradmin/payroll_data_form_date/' + st + '/' + end + '/' + $('#companyid').val();

        } else {
            url = '<?php echo base_url(); ?>index.php/masteradmin/payroll_ajax';
        }
        var settings = {
            "autoWidth": false,
            "sDom": "<'table-responsive't><'row'<p i>>",
...
//            },
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url(); ?>index.php/masteradmin/payroll_ajax',
            "bJQueryUI": true,
            "sPaginationType": "full_numbers",
            "iDisplayStart ": 20,
            "oLanguage": {
...
//                                            
                                            ...
                                            <!--                                                <td class="v-align-middle"><a href="--><?php //echo base_url('index.php/masteradmin/DriverDetails/'.$result->mas_id)  ?><!--"><button class="btn btn-success btn-cons" style="min-width: 83px !important;">DETAILS</button></a>-->
                                            <!--                                                    <a href="--><?php //echo base_url('index.php/masteradmin/Driver_pay/'.$result->mas_id)  ?><!--"><button class="btn btn-success btn-cons" style="min-width: 83px !important;">Pay</button></a>-->
                                            <!--                                                </td>-->
                                            <!---->
                                            <!--                                            </tr>-->
                                            <!--                                            --><?php
