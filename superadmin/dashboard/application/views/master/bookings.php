...
//            $('#createcontrollerurl').attr('href','<?php // echo base_url()  ?>//index.php/masteradmin/Get_dataformdate_for_all_bookingspg/'+st+'/'+end+'/'+$(this).val()+'/'+$('#companyid').val());
            ...
            var settings = {
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": '<?php echo base_url() ?>index.php/masteradmin/Get_dataformdate_for_all_bookingspg/' + st + '/' + end + '/' + $('#Sortby').val() + '/' + $('#companyid').val(),
                "bJQueryUI": true,
        ...
        $("#chekdel").click(function () {
            ...
            if (val.length > 0) {
                if (confirm("Are you sure to Delete " + val.length + " Vehicle")) {
                    $.ajax({
                        url: "<?php echo base_url('index.php/masteradmin') ?>/deleteVehicles",
                        type: "POST",
                        data: {val: val},
                        dataType: 'json',
    ...
    function route_map($dis) {
        ...
        $.ajax({
            url: "<?php echo base_url('index.php/masteradmin') ?>/getmap_values",
            type: "POST",
            data: {mapval: val},
            dataType: 'json',
...
//            "bProcessing": true,
//            "bServerSide": true,
//            "sAjaxSource": '<?php //echo base_url();   ?>//index.php/masteradmin/bookings_data_ajax',
//            "bJQueryUI": true,
//            "sPaginationType": "full_numbers",
//            "iDisplayStart ":20,
//            "oLanguage": {
...
//            },
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url(); ?>index.php/masteradmin/bookings_data_ajax/' + '<?php echo $status ?>',
            "bJQueryUI": true,
            "sPaginationType": "full_numbers",
            "iDisplayStart ": 20,
            "oLanguage": {
        ...
        $('#Sortby').change(function () {
            ...
            var settings = {
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": '<?php echo base_url(); ?>index.php/masteradmin/bookings_data_ajax/' + $(this).val() + '/' + $('#companyid').val(),
                "bJQueryUI": true,
                "sPaginationType": "full_numbers",
                "iDisplayStart ": 20,
                "oLanguage": {
    ...
    function refreshTableOnCityChange() {
        ...
        if ($('#start').val() != '' || $('#end').val() != '') {
            ...
            url = '<?php echo base_url() ?>index.php/masteradmin/Get_dataformdate_for_all_bookingspg/' + st + '/' + end + '/' + $('#Sortby').val() + '/' + $('#companyid').val();

        } else {
            url = '<?php echo base_url(); ?>index.php/masteradmin/bookings_data_ajax/' + $('#Sortby').val() + '/' + $('#companyid').val();
        }
        var settings = {
            "autoWidth": false,
            "sDom": "<'table-responsive't><'row'<p i>>",
        ...
        <div class="jumbotron" data-pages="parallax">
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
                ...
                <div class="panel panel-transparent ">
                    ...
                    <!--                        <a  href="--><?php //echo base_url();   ?><!--index.php/masteradmin/bookings/1"><span>DRIVER ON THE WAY</span></a>-->
                    <!--                    </li>-->
                    <!--                   <li class="--><?php //echo ($status ==2 ? "active": "");   ?><!--">-->
                    <!--                        <a  href="--><?php //echo base_url();   ?><!--index.php/masteradmin/bookings/2"><span>DRIVER ARRIVED</span></a>-->
                    <!--                    </li>-->
                    <!--                     <li class="--><?php //echo ($status ==3 ? "active": "");   ?><!--">-->
                    <!--                        <a  href="--><?php //echo base_url();   ?><!--index.php/masteradmin/bookings/3"><span>BOOKING STARTED</span></a>-->
                    <!--                    </li>-->
                    <!--                  -->
                    <!--                     <li class="--><?php //echo ($status ==4 ? "active": "");   ?><!--">-->
                    <!--                        <a  href="--><?php //echo base_url();   ?><!--index.php/masteradmin/bookings/4"><span>BOOKING COMPLETED</span></a>-->
                    <!--                    </li>-->
                    <!--                      <li class="--><?php //echo ($status == 5 ? "active": "");   ?><!--">-->
                    <!--                        <a  href="--><?php //echo base_url();   ?><!--index.php/masteradmin/bookings/5"><span>BOOKING CANCELLED</span></a>-->
                    <!--                    </li>-->
                    <!--                    -->
                    <!--                </ul>-->
                        ...
                        <div class="container-fluid container-fixed-lg bg-white">
                            ...
                            <div class="panel panel-transparent">
                                <div class="panel-heading">
                                    <!--                                --><?php //if($status == '5') {  ?>
                                    <!--                                    <div class="pull-left"><a href="--><?php //echo base_url()  ?><!--index.php/masteradmin/addnewvehicle"> <button class="btn btn-primary btn-cons">ADD</button></a></div>-->
                                    <!--                                --><?php //}  ?>
                                    <div class="pull-left">
                                    ...
                                    <div class="row clearfix pull-right" >
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <!--                                        <div class="dltbtn">
                                                                                                                            ...
                                                                                                                            <div class="pull-right"> <a href="<?php //echo base_url()  ?>index.php/masteradmin/callExel/<?php //echo $stdate;  ?>/<?php //echo $enddate  ?>"> <button class="btn btn-primary" type="submit">Export</button></a></div>
                                            <?php if ($status == '5') { ?>
                                                                                                    <div class="btn-group">
