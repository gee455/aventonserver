                                    ...
                                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                                        <span class="col-xs-height col-middle">
                                            <span class="thumbnail-wrapper d32 circular bg-success">
                                                <img width="34" height="34" alt="" data-src-retina="<?php echo base_url(); ?>theme/assets/img/profiles/1x.jpg" data-src="<?php echo base_url(); ?>theme/assets/img/profiles/1.jpg" src="<?php echo base_url(); ?>theme/assets/img/profiles/1x.jpg" class="col-top">
                                            </span>
                                        </span>
                            ...
                            <ul>
                                ...
                                <li class="chat-user-list clearfix">
                                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                                        <span class="col-xs-height col-middle">
                                            <span class="thumbnail-wrapper d32 circular bg-success">
                                                <img width="34" height="34" alt="" data-src-retina="<?php echo base_url(); ?>theme/assets/img/profiles/2x.jpg" data-src="<?php echo base_url(); ?>theme/assets/img/profiles/2.jpg" src="<?php echo base_url(); ?>theme/assets/img/profiles/2x.jpg" class="col-top">
                                            </span>
                                        </span>
                                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
                                ...
                                <li class="chat-user-list clearfix">
                                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                                        <span class="col-xs-height col-middle">
                                            <span class="thumbnail-wrapper d32 circular bg-success">
                                                <img width="34" height="34" alt="" data-src-retina="<?php echo base_url(); ?>theme/assets/img/profiles/3x.jpg" data-src="<?php echo base_url(); ?>theme/assets/img/profiles/3.jpg" src="<?php echo base_url(); ?>theme/assets/img/profiles/3x.jpg" class="col-top">
                                            </span>
                                        </span>
                                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
                    ...
                    <div class="chat-inner" id="my-conversation">
                        ...
                        <div class="message clearfix">
                            <div class="profile-img-wrapper m-t-5 inline">
                                <img class="col-top" width="30" height="30" src="<?php echo base_url(); ?>theme/assets/img/profiles/avatar_small.jpg" alt="" data-src="<?php echo base_url(); ?>theme/assets/img/profiles/avatar_small.jpg" data-src-retina="<?php echo base_url(); ?>theme/assets/img/profiles/avatar_small2x.jpg">
                            </div>
...
<div class="overlay" style="display: none" data-pages="search">
    ...
    <div class="overlay-content has-results m-t-20">
        ...
        <div class="container-fluid">
            <!-- BEGIN Overlay Logo !-->
            <img class="overlay-brand" src="<?php echo base_url(); ?>theme/assets/img/logo.png" alt="logo" data-src="<?php echo base_url(); ?>theme/assets/img/logo.png" data-src-retina="<?php echo base_url(); ?>theme/assets/img/logo_2x.png" width="78" height="22">
            <!-- END Overlay Logo !-->
            <!-- BEGIN Overlay Close !-->
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="">
                            ...
                            <div class="thumbnail-wrapper d48 circular bg-success text-white inline m-t-10">
                                <div>
                                    <img width="50" height="50" src="<?php echo base_url(); ?>theme/assets/img/profiles/avatar.jpg" data-src="<?php echo base_url(); ?>theme/assets/img/profiles/avatar.jpg" data-src-retina="<?php echo base_url(); ?>theme/assets/img/profiles/avatar2x.jpg" alt="">
                                </div>
                            </div>
...
<script src="<?php echo base_url(); ?>theme/assets/js/bootsrap_dropdwn.js" type="text/javascript"></script>


<script src="<?php echo base_url(); ?>theme/assets/plugins/nvd3/src/models/lineWithFocusChart.js" type="text/javascript"></script>
<script src="<?php echo base_url(); ?>theme/assets/plugins/bootstrap3-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>theme/assets/plugins/jquery-autonumeric/autoNumeric.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>theme/assets/plugins/dropzone/dropzone.min.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>theme/assets/plugins/bootstrap-tag/bootstrap-tagsinput.min.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>theme/assets/plugins/jquery-inputmask/jquery.inputmask.min.js"></script>
<script src="<?php echo base_url(); ?>theme/assets/plugins/boostrap-form-wizard/js/jquery.bootstrap.wizard.min.js" type="text/javascript"></script>
...
<script src="<?php echo base_url(); ?>theme/<?php echo base_url(); ?>theme/assets/plugins/summernote/js/summernote.min.js" type="text/javascript"></script>


<script src="<?php echo base_url(); ?>theme/pages/js/pages.min.js"></script>
<script src="<?php echo base_url(); ?>theme/pages/js/pages.js" type="text/javascript"></script>
<!-- END CORE TEMPLATE JS -->

<script src="<?php echo base_url(); ?>theme/assets/js/datatables.js" type="text/javascript"></script>
<!-- BEGIN PAGE LEVEL JS -->


<script src="<?php echo base_url(); ?>theme/assets/js/portlets.js" type="text/javascript"></script>

<script src="<?php echo base_url(); ?>theme/assets/js/form_elements.js" type="text/javascript"></script>
<script src="<?php echo base_url(); ?>theme/assets/js/charts.js" type="text/javascript"></script>
