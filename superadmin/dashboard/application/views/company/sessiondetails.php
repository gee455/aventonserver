    ...
    <div class="content">
        ...
        <div class="brand inline" style="  width: auto;
           ...
           <!--                    <img src="--><?php //echo base_url();         ?><!--theme/assets/img/Rlogo.png" alt="logo" data-src="--><?php //echo base_url();         ?><!--theme/assets/img/Rlogo.png" data-src-retina="--><?php //echo base_url();         ?><!--theme/assets/img/logo_2x.png" width="93" height="25">-->
            ...
            <strong style="color:#0090d9;"><a href="<?php echo base_url()?>index.php/superadmin/Drivers/my/1">SESSION DETAILS</a></strong><!-- id="define_page"-->
        </div>
        <!-- START JUMBOTRON -->
                                    ...
                                    <div id="tableWithSearch_wrapper" class="dataTables_wrapper form-inline no-footer"><div class="table-responsive"><table class="table table-hover demo-table-search dataTable no-footer" id="big_table" role="grid" aria-describedby="tableWithSearch_info">
                                                <thead>
                                                    ...
                                                    <tr role="row">
                                                        ...
                                                        <th class="sorting" tabindex="0" aria-controls="tableWithSearch" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 150px;font-size: 14px;">ON THE JOB</th>
                                                        <th class="sorting" tabindex="0" aria-controls="tableWithSearch" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 150px;font-size: 14px;">OFF THE JOB</th>
                                                        <th class="sorting" tabindex="0" aria-controls="tableWithSearch" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 150px;font-size: 14px;">DURATION</th>
                                                        <th class="sorting" tabindex="0" aria-controls="tableWithSearch" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 150px;font-size: 14px;">DISTANCE</th>
                                                    </tr>
...
-->                                                    <tr role="row"  class="gradeA odd">
                                                        <td id = "d_no" class="v-align-middle sorting_1"> <p>NUMBER</p></td>
                                                        <td id = "d_no" class="v-align-middle sorting_1 mname">3/4/2014</td>
                                                        <td class="v-align-middle"><a target="__blank" href="<?php echo base_url()?>index.php/superadmin/sessiondetails"><button>session details</button></a></td>
