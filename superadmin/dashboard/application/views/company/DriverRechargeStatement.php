...
//            },
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": '<?php echo base_url(); ?>index.php/superadmin/DriverRechargeStatement_ajax/<?php echo $driverId;?>',
            "bJQueryUI": true,
...
<div class="page-content-wrapper">
    ...
    <div class="content"style="padding-top: 80px">
        <ul class="breadcrumb" style="margin-left: 20px;">
            <li><a href="<?php echo base_url()?>index.php/superadmin/DriverRecharge" class="">DRIVER STATEMENTS</a>
            </li>
