                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input id="expirationrc" name="expirationrc" required="required"  type="" class="form-control datepicker-component"
                                                   value="<?php echo $expiredate;?>" autocomplete="off">
                                        </div>
...
<!--                                     <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input id="expirationPassbook" name="expirationPassbook" required="required" value="<?php echo $passbookExp;?>"  type="" class="form-control datepicker-component" autocomplete="off" >
                                        </div>
