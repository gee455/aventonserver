...
//                            $(".close").trigger("click");
                        ...
                        var settings = {
                            ...
                            "bProcessing": true,
                            "bServerSide": true,
                            "sAjaxSource": "<?php echo base_url() ?>index.php/superadmin/datatable_promodetails/<?php echo $mid;?>",
                            "bJQueryUI": true,
                ...
                <div class="panel panel-transparent ">
                    ...
                    <ul class="nav nav-tabs nav-tabs-fillup  bg-white">
                        ...
                        <li class="active" style="cursor:pointer">
                            <a  data = "<?php echo base_url(); ?>index.php/superadmin/datatable_promodetails/<?php echo $mid;?>"><span><?php echo LIST_OF_PROMOTION_ANALYTICS; ?></span></a>
                        </li>
