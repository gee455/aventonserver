...
define("DELETE_PASSENGER", "Are you sure to delete this passenger");

define("NAV_DASHBOARD", "DASHBOARD");
define("BUTTON_DELETE_PASSENGER", "Delete");
// RedisPrice
define("SETTING_PRICE", "SET COMMISION");

define("POPUP_RESET_IFMORETHENONE", "ATLEAST ONE YOU NEED TO SELECT");
define("POPUP_RESET_GETONE", "YOU HAVE SELECTED MORETHEN ONE");


define("LIST_MAP", "DRIVER ROOT MAP");
...
define("NAV_BOOKINGS", "ALL DISPATCHED JOBS");
...
define("LIST_DRIVER_EDIT", "EDIT DRIVER");
...
define("LIST_DRIVER_DRIVINGLICENCE", "DRIVING LICENCE");
...
define("ARE_YOU_SURE_TO_LOGOUT_THIS_DRIVER", "Are you sure to logout this driver ?");
define("BUTTON_YES", "Yes ");
define("BUTTON_NO", "No ");
define("BUTTON_OK", "OK ");
define("CITY_DELETE", "Are you sure you want to delete this city");
...
define("BUTTON_MANUAL_LOGOUT", "Manually Logout");
define("BUTTON_ADD_NEW", "Configure & Activate City ");
define("POPUP_VEHICLE_MAKE", "Are you sure do you want to delete vehicle make");
define("BUTTON_ACTIVATE", "Activate ");
define("BUTTON_ACCEPT", "Accept ");
define("BUTTON_ACTIVE", "Active ");
define("DISPTACH_DELETE", "Are you sure to delete..?");
...
define("POPUP_CITIES_CITY_ENTER_COUNTRY", "Please select the country");
...
define("POPUP_COMPANY_EMAIL", "Please enter your Email ID");
...
define("POPUP_SELECT_VINSURENCENUMBER_INSURENCE", "Please upload  the  motor insurance certificate");
...
define("POPUP_DRIVER_FILE_POPUP_EXPERIENCE_PASSBOOK", "Please choose the expiredate of bank passbook");
...
define("POPUP_ACCEPTED", "Do you want to activate this company, make sure all the documents provided while registering is verified");
define("POPUP_REJECTED", "Do you want to deactivate this company, make sure all the documents provided while registering is verified");
define("POPUP_SUSPENDED", "Are you sure you want to suspend this company and have validated all of Its documents ,etc. ? ");
define("POPUP_DELETE", "Are you sure do you want to delete this Company and have validated all of its documents ,etc. ? ");



define("POPUP_DELETEVEHICLETYPE", "Are you sure to delete this vehicle type?, Once deleted it will deleted permanently");
define("POPUP_DELETECOMPANY", "Are you sure to delete this company?, Once deleted it will deleted permanently ");
define("POPUP_DELETECOUNTRY", "Are you sure to delete this country ?, Once deleted it will deleted permanently ");
define("POPUP_DELETECITY", "Are you sure to delete this city ?, Once deleted it will deleted permanently ");
define("POPUP_DELETEDRIVER", "Are you sure to delete this driver ?,Once deleted it will deleted permanently");
define("POPUP_DELETEDVEHICLEMODAL", "Are you sure to delete this vehicle model ?, Once deleted it will deleted permanently ");
define("POPUP_DELETEVEHICLEMODAL", "Please select vehicle model to delete ?, Once deleted it will deleted permanently ");

define("POPUP_COMPANY_DELETE_DELETE_VEHICLETYPE", "your selected vehicle type deleted successfully");
define("POPUP_COMPANY_DELETE_DELETE_COMPANY", "your selected company deleted successfully");
define("POPUP_COMPANY_DELETE_DELETE_COUNTRY", "your selected country has been deleted successfully");
define("POPUP_COMPANY_DELETE_DELETE_CITY", "your selected city has been deleted successfully");
define("POPUP_COMPANY_DELETE_DELETE_DRIVERDELETE", "your selected driver deleted successfully");
define("POPUP_COMPANY_DELETE_DELETE_MODELDELETE", "your selected model deleted sucessfully");
...
define("POPUP_COMPANY_PINCODE_NAME", "Please enter the pin code");
define("POPUP_COMPANY_ADDED", "Your company updated successfully");

define("POPUP_CANCEL", "Do you want to clear all details ?");
...
define("POPUP_VEHICLEMODEL", "are You Sure To Delete Vehicle types");
...
define("POPUP_VEHICLETYPE_ON_IMAGE", "Add the Vehicle on image");
define("POPUP_VEHICLETYPE_OFF_IMAGE", "Add the vehicle off image first");
define("POPUP_VEHICLETYPE_MAP_IMAGE", "Add the map icon image first");

define("FIELD_VEHICLETYPE_ONIMAGE", "VEHICLE ON IMAGE");
define("FIELD_VEHICLETYPE_OFFIMAGE", "VEHICLE OFF IMAGE");
define("FIELD_VEHICLETYPE_MAPIMAGE", "MAP ICON");
...
define("POPUP_VEHICLETYPE_SUREDELETE", "Are you sure you want to delete vehicle types");
...
define("POPUP_PASSENGERS_ATLEAST", "Select at least one passenger");
define("POPUP_DRIVERS_ATLEAST", "Select at least one driver");
...
define("POPUP_MSG_ACCEPTED", "Your profile has been activated now you can login as a driver");
define("POPUP_MSG_LOGOUT", "Your selected driver is loggedout successfully");
...
define("FIELD_VEHICLETYPE_MINIMUMFARE", "MINIMUM FARE (".currency.")");
define("FIELD_VEHICLETYPE_BASEFARE", "BASE FARE (".currency.")");
define("FIELD_VEHICLETYPE_PRICEMINUTE", "PRICE PER MINUTE (".currency.")");
define("FIELD_VEHICLETYPE_PRICEKM", "PRICE PER/MILE (".currency.")");
define("FIELD_VEHICLETYPE_WAITING_CHARGE", "WAITING CHARGE PER MINUTE (".currency.")");
define("FIELD_VEHICLETYPE_CANCILATIONFEE", "CANCELATION FEE (".currency.")");
...
define("FIELD_PASSBOOK_EXDATE", "EXPIRY DATE");
