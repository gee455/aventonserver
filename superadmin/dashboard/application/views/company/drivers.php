...
//                  
                ...
                var modalElem = $('#Model_manual_logout');
                if (size == "mini")
                {
                    $('#modalStickUpSmall').modal('show')
                }
...
//       $('#big_table_processing').show();
        ...
        $('#big_table').on('init.dt', function () {
            ...
            if (forwhat == 'my') {
                 if(status == 1 ){
                     $('#big_table').dataTable().fnSetColumnVis([5,6,7,8], false);
                }  
                else if(status == 3 ){
...
//            };
        ...
        var tab_id = $(this).attr('data-id');
            if(tab_id == 1)
            {
                url = '<?php echo base_url(); ?>index.php/superadmin/datatable_drivers/my/1';
                status = 1;
            }
            else  if(tab_id == 2)
            {
                url = '<?php echo base_url(); ?>index.php/superadmin/datatable_drivers/my/3';
                status = 3;
            }
             else  if(tab_id == 3)
             {
                 url = '<?php echo base_url(); ?>index.php/superadmin/datatable_drivers/my/4';
                 status = 4;
             }
              else  if(tab_id == 4)
             {
                url = '<?php echo base_url(); ?>index.php/superadmin/datatable_drivers/mo/3';
                status = 5;
            }
             else  if(tab_id == 5)
             {
                url = '<?php echo base_url(); ?>index.php/superadmin/datatable_drivers/mo/30';
                status = 5;
            }
             else  if(tab_id == 6)
             {
                url = '<?php echo base_url(); ?>index.php/superadmin/datatable_drivers/mo/567';
                status = 6;
            }
        ...
        $('#big_table').on('init.dt', function () {
            ...
            {
                if (status != 3 ) {
                 $('#big_table').dataTable().fnSetColumnVis([11], false);
             }
            }
            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
                ...
                <div class="panel panel-transparent ">
                    ...
                    <ul class="nav nav-tabs nav-tabs-fillup  bg-white whenclicked">
                        ...
                        <div class=""><button class="btn btn-primary pull-right m-t-10 " id="driver_logout"  style="margin-left:10px;margin-top: 5px"><?php echo BUTTON_MANUAL_LOGOUT;?></button></div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="error-box" id="errorbox_logout" style="font-size: large;text-align:center"><?php echo ARE_YOU_SURE_TO_LOGOUT_THIS_DRIVER; ?></div>
