        ...
        <div class="jumbotron" data-pages="parallax">
            ...
            <div class="inner">
                ...
                <ul class="breadcrumb" style="margin-left: 20px;">
                    ...
                    <li ><a href="#" class="active"> REFERRAL DETAILS</a>
                    </li>
                ...
                <div class="panel panel-transparent ">
                    ...
                    <ul class="nav nav-tabs nav-tabs-fillup  bg-white">
                        ...
                        <li class="active" style="cursor:pointer">
                            <a  data = "<?php echo base_url(); ?>index.php/superadmin/referral_details"><span>REFFERAL DETAILS</span></a>
                        </li>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div id="tableWithSearch_wrapper" class="dataTables_wrapper form-inline no-footer"><div class="table-responsive"><table class="table table-hover demo-table-search dataTable no-footer tableWithSearch_referels" id="tableWithSearch" role="grid" aria-describedby="tableWithSearch_info" style="margin-top: 30px;">
                                                <thead>
                                                    ...
                                                    <tr role="row">
                                                        <th  rowspan="2" class="sorting_asc " tabindex="0" aria-controls="tableWithSearch" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column ascending" style="width: 87px;font-size:15px">USER ID</th>
                                                        <th  rowspan="2" class="sorting_asc " tabindex="0" aria-controls="tableWithSearch" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column ascending" style="width: 87px;font-size:15px">NAME</th>
                                                        <th  rowspan="2" class="sorting_asc " tabindex="0" aria-controls="tableWithSearch" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column ascending" style="width: 87px;font-size:15px">EMAIL</th>
                                                        <th  rowspan="2" class="sorting_asc " tabindex="0" aria-controls="tableWithSearch" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column ascending" style="width: 87px;font-size:15px">REFERRAL CODE</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                    foreach ($referral_details[0]['signups'] as $data) {
//                                                        print_r($data);
                                                        ?>
                                                        <tr role="row"  class="gradeA odd">
                                                            <td  class="v-align-middle sorting_1 "><?php echo $data['slave_id'] ?></td>
                                                            <td class="v-align-middle sorting_1 "><?php echo $data['fname'] ?></td>
                                                            <td  class="v-align-middle sorting_1 "><?php echo $data['email'] ?></td>
                                                             <td class="v-align-middle sorting_1">
                                                          <a  href="<?php echo base_url(); ?>index.php/superadmin/refered/<?php echo $coupon_id;?>/<?php echo $data['coupon_code'] ?>"><?php echo $data['coupon_code'] ?></a></td>
                                                                         
                                                            <!--<td  class="v-align-middle sorting_1 "><?php echo $data['coupon_code'] ?></td>-->
                                                            <td  class="v-align-middle sorting_1 "><?php echo date('Y-m-d H:i:s', $data['created_dt']); ?></td>
                                                        </tr>
                                                        <?php
                                                    }
                                                    ?>
