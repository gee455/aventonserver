        ...
        $('#editcitypage').click(function () {
            ...
            if (val.length == 0) {
                ...
                $("#display-data").text(<?php echo json_encode(POPUP_CITY_ONLYONE); ?>);
                 ...
                 $.ajax({
                    url: "<?php echo base_url('index.php/superadmin') ?>/getCityDetails",
                    type: 'POST',
                    data: {
                        dis_id: val,
                    ...
                    success: function (response)
                    {
                       ...
                       {
                           $('#cityval').val(row.city);
                           $('#edit_email').val(row.dis_email);
                           $('#edit_name').val(row.dis_name);
    ...
    <div class="content">
        ...
        <div class="brand inline" style="  width: auto;
           ...
           <!--                    <img src="--><?php //echo base_url();               ?><!--theme/assets/img/Rlogo.png" alt="logo" data-src="--><?php //echo base_url();               ?><!--theme/assets/img/Rlogo.png" data-src-retina="--><?php //echo base_url();               ?><!--theme/assets/img/logo_2x.png" width="93" height="25">-->
            ...
            <strong style="color:#0090d9;">CITIES</strong><!-- id="define_page"-->
        </div>
                ...
                <div class="panel panel-transparent ">
                    ...
                    <ul class="nav nav-tabs nav-tabs-fillup  bg-white">
                        ...
                        <li class="active" style="cursor:pointer">
                            <a  data = "<?php echo base_url(); ?>index.php/superadmin/datatable_cities/2"><span><?php echo LIST_OF_CITIES; ?></span></a>
                        </li>
